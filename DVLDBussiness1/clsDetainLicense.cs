...
namespace DVLDBussiness1
{
    public class clsDetainLicense
    {
        ...
        public clsDetainLicense(int DetainID,
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID =DVLDDataAccess.clsDetainedLicense.AddNewDetainedLicense(
        ...
        private bool _UpdateDetainedLicense()
        {
            ...
            return DVLDDataAccess.clsDetainedLicense.UpdateDetainedLicense(
        ...
        public static clsDetainLicense Find(int DetainID)
        {
            ...
            if (DVLDDataAccess.clsDetainedLicense.GetDetainedLicenseInfoByID(DetainID,
            ref LicenseID, ref DetainDate,
            ref FineFees, ref CreatedByUserID,
            ref IsReleased, ref ReleaseDate,
            ref ReleasedByUserID, ref ReleaseApplicationID))

                return new clsDetainLicense(DetainID,
        ...
        {
            return DVLDDataAccess.clsDetainedLicense.GetAllDetainedLicenses();
        ...
        public static clsDetainLicense FindByLicenseID(int LicenseID)
        {
            ...
            if (DVLDDataAccess.clsDetainedLicense.GetDetainedLicenseInfoByLicenseID(LicenseID,
        ...
        {
            return DVLDDataAccess.clsDetainedLicense.IsLicenseDetained(LicenseID);
        }

        public bool ReleaseDetainedLicense(int ReleasedByUserID, int ReleaseApplicationID)
        {
            return DVLDDataAccess.clsDetainedLicense.ReleaseDetainedLicense(this.DetainID,
                   ReleasedByUserID, ReleaseApplicationID);
        }
    }
}
