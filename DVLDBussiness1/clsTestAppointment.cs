...
namespace DVLDBussiness1
{
    public class clsTestAppointment
    {
        ...
        public clsManageTestType.enTestType TestTypeID { set; get; }
...

        {
            ...
            this.TestTypeID = clsManageTestType.enTestType.VisionTest;
        ...
        public clsTestAppointment(int TestAppointmentID, clsManageTestType.enTestType TestTypeID,
        ...
        public static clsTestAppointment Find(int TestAppointmentID)
        {
            ...
            if (clsTestAppointmentData.FindTestAppointment(TestAppointmentID, ref TestTypeID, ref LocalDrivingLicenseApplicationID,
               ref AppointmentDate, ref PaidFees, ref CreatedByUserID, ref IsLocked, ref RetakeTestApplicationID))
                return new clsTestAppointment(TestAppointmentID, (clsManageTestType.enTestType)TestTypeID, LocalDrivingLicenseApplicationID, AppointmentDate, PaidFees, CreatedByUserID, IsLocked, RetakeTestApplicationID);
            else
                return null;
        }
        public static clsTestAppointment GetLastTestAppointment(int LocalDrivingLicenseApplicationID,clsManageTestType.enTestType TestTypeID)
        {
        ...
        public static DataTable GetApplicationTestAppointmentsPerTestType(int LocalDrivingLicenseApplicationID,clsManageTestType.enTestType TestType)
        {
            return clsTestAppointmentData.GetApplicationTestAppointmentsPerTestType(LocalDrivingLicenseApplicationID,(int) TestType);
        }
        public DataTable GetApplicationTestAppointmentsPerTestType(clsManageTestType.enTestType TestType)
        {
